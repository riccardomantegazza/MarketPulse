"""Core analytics used across the Market Pulse project."""
...
def log_returns(px: pd.DataFrame) -> pd.DataFrame:
    """Return daily log-returns for a price DataFrame."""
...
def rolling_average_pairwise_corr(
    ...
    """Compute the Market Shift Index (average pairwise correlation)."""
    if window < 2:
